...
export const CARDS = [
  ...
  },
  {
    ...
    background: (
      <Integrations className="absolute right-2 pl-28 md:pl-0 top-4 h-100 w-200 border-none transition-all duration-300 ease-out mask-[linear-gradient(to_top,transparent_10%,#000_100%)] group-hover:scale-105" />
    ),
  },
  {
    Icon: CalendarIcon,
